...
ADMIN_USRNM = environ.get('ADMIN_USRNM','@FireChannels_AdminBot') # WITHOUT @
MAIN_CHANNEL_USRNM = environ.get('MAIN_CHANNEL_USRNM','MovieFireTamil') # WITHOUT @
DEV_CHANNEL_USRNM = environ.get('DEV_CHANNEL_USRNM','AnimeFireTamil') # WITHOUT @
...
MULTI_CLIENT = False
name = str(environ.get('name', 'MovieFireTamil'))
...
DOWNLOAD_TEXT_URL = "https://t.me/MovieFireTamil/6"

# Custom Caption Under Button #
CAPTION_BUTTON = "For Animes"
